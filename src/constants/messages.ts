...
export const ERROR_MESSAGES = {
  ...
  // ストレージエラー
  STORAGE_QUOTA_EXCEEDED: "ストレージ容量が不足しています。不要なデータを削除してください",
  STORAGE_SAVE_FAILED: "データの保存に失敗しました",
  STORAGE_LOAD_FAILED: "データの読み込みに失敗しました",
  STORAGE_PARSE_FAILED: "保存されたデータの形式が正しくありません",

  // ネットワークエラー
  NETWORK_CONNECTION_ERROR: "ネットワーク接続エラーです。インターネット接続を確認してください",
  NETWORK_TIMEOUT_ERROR: "接続がタイムアウトしました。しばらく時間をおいて再試行してください",
